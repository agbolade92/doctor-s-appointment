...
public class AppointmentController {
    ...
    public String saveAppointment(HttpServletRequest request, HttpSession session) throws ParseException {
        ...
        java.sql.Date appointmentDate =  java.sql.Date.valueOf(request.getParameter("appointmentDate"));
...
//        existingAppointment.setDoctor(doctorService.findDoctorById(doctor.getId()));
